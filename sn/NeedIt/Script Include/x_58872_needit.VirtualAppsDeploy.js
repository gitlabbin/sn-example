 ...
 * Created On  : 2018-11-13 03:04:07
 * Created By  : admin
 * Updated On  : 2018-11-13 03:09:34
 * Updated By  : admin
 * URL         : - /sys_script_include.do?sys_id=d27948b4db7d2300f526d426ca961969
 */
var VirtualAppsDeploy = Class.create();
VirtualAppsDeploy.prototype = {
    /*
        Installation:
    ...
    */
    ...
    commitUpdateSet: function () {
        ...
        return {
            ...
            endpoint: 'xmlhttp.do',
            headers: {
                'X-UserToken': gs.getSession().getSessionToken()
            },
            validate: {
